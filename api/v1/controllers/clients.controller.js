...
//const errorHandler = require( path.join(__dirname, '../middleware/error-handler') );
...
router.post('/', authorize([Role.Admin, Role.ProjectLeader, Role.Developer]), createSchema, create);
router.put('/:id/restore', authorize([Role.Admin, Role.ProjectLeader, Role.Developer]), restore);
router.put('/:id/update-status', authorize([Role.Admin, Role.ProjectLeader, Role.Developer]), updateStatusSchema, updateStatus);
router.put('/:id', authorize([Role.Admin, Role.ProjectLeader, Role.Developer]), updateSchema, update);
router.delete('/:id', authorize([Role.Admin, Role.ProjectLeader, Role.Developer]), _delete);

module.exports = router;

function getAll(req, res, next) {
	clientService.getAll(req.user.role)
...
function update(req, res, next) {
	...
	//console.log('update req:', req.params, req.body);
