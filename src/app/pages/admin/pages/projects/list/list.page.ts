...
import { Account, BannerSize, BannerType, Client, Project, Template } from '@app/core/models';
import { AccountService, AlertService, BannerSizeService, BannerTypeService, ClientService, ProjectService, TemplateService } from '@app/core/services';
...
export class ProjectsListPage implements OnInit, OnDestroy {
	...
	ngOnDestroy(): void {
		//console.warn('Projects List ngOnDestroy');
		...
		this.introJS.setOptions({
			...
			steps: [
				...
				},
				{
					...
					intro: "Click here to download a spreadsheet with a list of all projects.",
				},
				{
				...
				},
				{
					...
					intro: "Click here to enable project so it can be visible on dashboard or disable for it to be invisible.",
				},
				{
					element: '#edit-btn',
					intro: "Click here to edit project details.",
				},
				{
					element: '#btn-audit',
					intro: "Click here to get history about project.",
				},
				{
					element: '#btn-delete',
					intro: "Click here to delete project.",
				},
			],
	...
	public export(): void {
		...
		/* save to file */
		XLSX.writeFile(wb, 'BAPP_Projects.xlsx');
